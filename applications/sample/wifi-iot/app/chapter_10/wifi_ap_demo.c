...
*/
    ...
    rc = memcpy_s(hapd_conf.key, HI_WIFI_MAX_KEY_LEN + 1, PASSWORD, 9); /* 9:ssid 
length */
    if (rc != EOK)
    {
        return ;
    ...
    IP4_ADDR(&st_gw, 192, 168, 75, 128);       /* input your IP for example: 192.168.1.1 
*/
    IP4_ADDR(&st_ipaddr, 192, 168, 75, 128);   /* input your netmask for example: 
192.168.1.1 */
    IP4_ADDR(&st_netmask, 255, 255, 255, 0); /* input your gateway for example: 
255.255.255.0 */
